...
# http://www.talentinsta.com/tllink/tllink.php?mode=ct&ct=0&p=#{num}
...
range = 1..2
range.each{ |num|
	Anemone.crawl("http://www.talentinsta.com/tllink/tllink.php?mode=ct&ct=0&p=#{num}",:depth_limit => 0) do |anemone|
